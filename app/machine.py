...
import os  # For using filepath from main.py
...
class Machine:  # machine.py for section named "view"
    ...
    @staticmethod
    def open(filepath):  # open the filepath defined inside main.py
        return joblib.load(filepath)

    def save(self, filepath):
        directory = os.path.dirname(filepath)  # specify directory on operating system
